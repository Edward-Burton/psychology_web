					...
					<li class="comment-item">
						...
						<div class="comment-infos">
							<div class="commenter-wrap">
								...
								<!-- 名字 -->
								<div class="commenter-name">五年</div>
								<!-- 已经赞 加类名liked -->
								<div onclick="like(this)" class="like-action "
									data-comment-id="10752">
		...
		<div class="main-right">
			<div class="lecturer-item" style="width: 100%;">
				...
				<p class="lecturer-title">
					北京心理危机研究与干预中心、北京回龙观医院心理科副主任<br>医师、副教授 <br>中华医学会、中国医师协会会员
					中国心理学会、中国心理卫生协会会员<br>
				</p>
...
//	              },
		  ...
		  methods: {
			  ...
			  play(e){
				  ...
				  this.coursePlayer = videojs("course-video", this.playOptions, function() {
				        coursePlayer.src(this.mediaUrl);
				        coursePlayer.load(this.mediaUrl);
				        coursePlayer.play();
				  });
			  },
			  getLessionList(){
