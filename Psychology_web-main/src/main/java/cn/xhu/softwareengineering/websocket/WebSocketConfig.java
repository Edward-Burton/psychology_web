...
public class WebSocketConfig implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		//添加一个处理器还有定义处理器的处理路径
		registry.addHandler(webSocketHandler, "/ws.do").addInterceptors(chatHandshakeInterceptor);
		/*
		 ...
		 */
		registry.addHandler(webSocketHandler, "/ws/sockjs.do").addInterceptors(chatHandshakeInterceptor).withSockJS();
	}
